...
class MobileTermsAndConditionpage extends StatefulWidget {
  const MobileTermsAndConditionpage({Key? key}) : super(key: key);

  @override
  State<MobileTermsAndConditionpage> createState() =>
      _MobileTermsAndConditionpageState();
}

class _MobileTermsAndConditionpageState
    extends State<MobileTermsAndConditionpage> {
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          ...
          _infoChecked = _allChecked;
          _termChecked = _allChecked;
  ...
  Column _terms(BuildContext context) {
    return Column(
      children: [
        Container(
          width: 410.w,
  ...
  Column _personalnfo(BuildContext context) {
    return Column(
      children: [
        Container(
          width: 410.w,
    ...
    return Column(
      children: [
        GestureDetector(
          onTap: () {
            setState(() {
              _marketingChecked = !_marketingChecked;
              //checkAllChecked();
            });
          },
          child: Container(
...
String personalInfo = '''
< 캥스터즈 주식회사 >('https://kangsters-crew.com/'이하 '휠리엑스')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.	\n
	\n
○ 이 개인정보처리방침은 2022년 1월 1부터 적용됩니다.	\n
	\n
제1조(개인정보의 처리 목적)< 캥스터즈 주식회사 >('https://kangsters-crew.com/'이하 '휠리엑스')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.	\n
	\n
홈페이지 회원가입 및 관리	\n
	\n
...
신규 서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 제공 및 참여기회 제공 , 인구통계학적 특성에 따른 서비스 제공 및 광고 게재 , 서비스의 유효성 확인, 접속빈도 파악 또는 회원의 서비스 이용에 대한 통계 등을 목적으로 개인정보를 처리합니다.	\n
	\n
**제2조(개인정보의 처리 및 보유 기간)**① < 캥스터즈 주식회사 >은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.	\n
	\n
1.<재화 또는 서비스 제공>	\n
...
제3조(정보주체와 법정대리인의 권리·의무 및 그 행사방법)	\n
	\n
① 정보주체는 캥스터즈 주식회사에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.	\n
	\n
② 제1항에 따른 권리 행사는캥스터즈 주식회사에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 캥스터즈 주식회사은(는) 이에 대해 지체 없이 조치하겠습니다.	\n
	\n
...
⑤ 개인정보의 정정 및 삭제 요구는 다른 법령에서 그 개인정보가 수집 대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수 없습니다.	\n
	\n
⑥ 캥스터즈 주식회사은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.	\n
	\n
**제4조(처리하는 개인정보의 항목 작성)**① < 캥스터즈 주식회사 >은(는) 다음의 개인정보 항목을 처리하고 있습니다.	\n
	\n
1< 홈페이지 회원가입 및 관리 >	\n
필수항목 : 이메일, 휴대전화번호, 자택주소, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 신체정보, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록	\n
선택항목 :	\n
2< 재화 또는 서비스 제공 >	\n
필수항목 : 휴대전화번호, 자택주소, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 신체정보, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록	\n
	\n
제5조(개인정보의 파기)	\n
	\n
① < 캥스터즈 주식회사 > 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.② 정보주체로부터 동의받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의 데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다.1. 법령 근거 : 2. 보존하는 개인정보 항목 : 계좌정보, 거래날짜③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.1. 파기절차< 캥스터즈 주식회사 > 은(는) 파기 사유가 발생한 개인정보를 선정하고, < 캥스터즈 주식회사 > 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.	\n
	\n
파기방법	\n
	\n
전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용합니다	\n
	\n
제6조(개인정보의 안전성 확보 조치)< 캥스터즈 주식회사 >은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.	\n
	\n
정기적인 자체 감사 실시개인정보 취급 관련 안정성 확보를 위해 정기적(분기 1회)으로 자체 감사를 실시하고 있습니다.2. 개인정보 취급 직원의 최소화 및 교육개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화 하여 개인정보를 관리하는 대책을 시행하고 있습니다.3. 내부관리계획의 수립 및 시행개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다.4. 개인정보의 암호화이용자의 개인정보는 비밀번호는 암호화 되어 저장 및 관리되고 있어, 본인만이 알 수 있으며 중요한 데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을 사용하고 있습니다.5. 접속기록의 보관 및 위변조 방지개인정보처리시스템에 접속한 기록을 최소 1년 이상 보관, 관리하고 있으며,다만, 5만명 이상의 정보주체에 관하여 개인정보를 추가하거나, 고유식별정보 또는 민감정보를 처리하는 경우에는 2년이상 보관, 관리하고 있습니다.또한, 접속기록이 위변조 및 도난, 분실되지 않도록 보안기능을 사용하고 있습니다.6. 개인정보에 대한 접근 제한개인정보를 처리하는 데이터베이스시스템에 대한 접근권한의 부여,변경,말소를 통하여 개인정보에 대한 접근통제를 위하여 필요한 조치를 하고 있으며 침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있습니다.7. 문서보안을 위한 잠금장치 사용개인정보가 포함된 서류, 보조저장매체 등을 잠금장치가 있는 안전한 장소에 보관하고 있습니다.8. 비인가자에 대한 출입 통제개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고 있습니다.	\n
	\n
제7조(개인정보 자동 수집 장치의 설치•운영 및 거부에 관한 사항) ① 캥스터즈 주식회사 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다.가. 쿠키의 사용 목적 : 이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다.나. 쿠키의 설치•운영 및 거부 : 웹브라우저 상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다.다. 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.	\n
	\n
제8조 (개인정보 보호책임자) ① 캥스터즈 주식회사 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다. • ▶ 개인정보 보호책임자 • 성명 :김강 • 직책 :CEO • 직급 :CEO • 연락처 :031-506-0625, info@kang-sters.com, 031-506-0615 ※ 개인정보 보호 담당부서로 연결됩니다.	\n
	\n
② 정보주체께서는 캥스터즈 주식회사 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 캥스터즈 주식회사 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다. 제9조(가명정보의 처리) 제10조(개인정보 열람청구)정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다.< 캥스터즈 주식회사 >은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.	\n
	\n
• ▶ 개인정보 열람청구 접수·처리 부서 • 부서명 : 사업부 • 담당자 : 김강 • **연락처 :**031-506-0625, info@kang-sters.com, 031-506-0615 **제11조(권익침해 구제방법)정보주체는 개인정보침해로 인한 구제를 받기 위하여 개인정보분쟁조정위원회, 한국인터넷진흥원 개인정보침해신고센터 등에 분쟁해결이나 상담 등을 신청할 수 있습니다. 이 밖에 기타 개인정보침해의 신고, 상담에 대하여는 아래의 기관에 문의하시기 바랍니다.1. 개인정보분쟁조정위원회 : (국번없이) 1833-6972 (www.kopico.go.kr)2. 개인정보침해신고센터 : (국번없이) 118 (privacy.kisa.or.kr)3. 대검찰청 : (국번없이) 1301 (www.spo.go.kr)4. 경찰청 : (국번없이) 182 (ecrm.cyber.go.kr)「개인정보보호법」제35조(개인정보의 열람), 제36조(개인정보의 정정·삭제), 제37조(개인정보의 처리정지 등)의 규정에 의한 요구에 대 하여 공공기관의 장이 행한 처분 또는 부작위로 인하여 권리 또는 이익의 침해를 받은 자는 행정심판법이 정하는 바에 따라 행정심판을 청구할 수 있습니다.※ 행정심판에 대해 자세한 사항은 중앙행정심판위원회(www.simpan.go.kr) 홈페이지를 참고하시기 바랍니다. 제12조(개인정보 처리방침 변경)	\n
	\n
① 이 개인정보처리방침은 2022년 1월 1부터 적용됩니다.	\n
	\n
...
제1조 목적	\n
	\n
이 약관은 캥스터즈(주)(이하 ‘회사’)가 디바이스를 통해 제공하는 모바일서비스(이하 ‘서비스’)를 이용하는 서비스 이용자(이하 ‘이용자’)와 회사간에 서비스의 이용에 관한 기본적인 사항을 규정하는 것을 목적으로 합니다.	\n
	\n
제2조 용어의 정의	\n
	\n
① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.	\n
	\n
\"이용자\"란 본 약관에 따라 이용계약을 체결하고, 회사가 제공하는 모든 콘텐츠 및 제반 서비스를 이용하는 무료회원 및 유료회원을 말합니다.	\n
\"콘텐츠\"란 디바이스 등을 통하여 이용할 수 있도록 회사가 제공하는 모든 서비스와 관련되어 제작 및 내용물 일체를 말합니다.	\n
\"디바이스\"란 콘텐츠를 다운로드받거나 설치하여 사용할 수 있는 휴대전화, TV, 디지털 기기 등 회사가 제공하는 앱이나 웹사이트, 프로그램을 설치하여 회사의 서비스에 접속할 수 있는 기기를 말합니다.	\n
\"서비스\"란 유무선네트워크를 통하여 이용자가 콘텐츠를 이용할 수 있도록 회사가 제공하는 서비스 일체를 말합니다.	\n
“참가자”란 회사가 제공하는 서비스에 대한 내용을 숙지하고 회사가 정한 절차에 따라 무상 또는 유료로 해당 서비스에 참가 신청한 이용자를 말합니다.	\n
	\n
...
회사는 필요하다고 인정되는 경우 이 약관을 변경할 수 있습니다. 회사는 약관이 변경되는 경우에 변경된 약관의 내용과 적용일을 정하여, 적용일7일전 서비스 초기화면에 온라인으로 공시합니다. 다만, 이용자에게 불리하게 약관 내용을 변경하는 경우에는 적용일로부터 30일전 서비스 초기화면에 온라인으로 공시하고 콘텐츠 내 네트워크 서비스 접속 시 확인할 수 있게 공지합니다. 변경된 약관은 공시하거나 고지한 적용일로부터 효력이 발생합니다.	\n
...
기본적으로 이용자는 회사 약관 이용에 최초1회 동의 시 이후 회사에서 서비스되는 콘텐츠를 별도의 동의 없이 이용할 수 있습니다. 다만, 연령확인이 필요한 서비스 또는 별도의 법령에서 정하는 바에 따라 본인 확인 및 동의절차를 거쳐야 하는 콘텐츠의 경우는 그러하지 않습니다.	\n
이 약관은 대한민국 내에서만 유효합니다.	\n
	\n
제4조 약관 외 준칙 본 약관에 명시하지 아니한 사항에 대해서는 별도의 약관 혹은 정책을 둘 수 있으며, 약관 및 정책은 정부가 제정한 관계 법령 또는 상관례에 따릅니다.	\n
	\n
제2장 이용계약	\n
	\n
제5조 개인정보의 보호 및 사용	\n
...
해당 이용자콘텐츠를 이용하거나 편집 형식의 변경 및 기타의 방법으로 변형하는 것(공표, 복제, 공연, 전송, 배포, 방송, 2차적저작물 작성 등 어떠한 형태로든 이용 가능하며 이용기간과 지역에는 제한이 없음).	\n
...
회사는 이용자의 사전 동의 하에 이용자로부터 수집한 개인정보를 활용하여 제1항의 광고 및 제3항의 정보 등을 제공하는 경우SMS, 스마트폰 알림, e-mail을 활용하여 발송할 수 있으며, 이용자는 원하지 않을 경우 언제든지 수신을 거부할 수 있습니다.	\n
	\n
제4장 서비스 일반	\n
	\n
제11조 서비스의 제공	\n
	\n
회사는 다음과 같은 서비스를 제공합니다. 운동 동영상 시청 서비스 2. 운동 능력 실시간 측정 서비스 3.﻿운동 기록 확인 서비스 4. 기타 회사가 추가 개발하거나 다른 회사와의 제휴계약을 통해 이용자에게 제공하는 일체의 서비스	\n
...
제12조 서비스의 이용	\n
	\n
회사는 서비스를 업무상 또는 기술상 특별한 지장이 없는 한 연중 무휴, 1일24시간 제공하는 것을 원칙으로 합니다. 단, 시스템 정기점검, 서버의 증설 및 교체, 네트워크의 불안정 등 운영상 필요하다고 판단되는 경우에는 일정기간 동안 서비스를 일시 중지할 수 있으며 이 경우 회사는 사전에 이를 각 서비스의 초기화면 또는 콘텐츠 내 공지사항에 공지합니다.	\n
...
회사는 디바이스를 위한 전용 애플리케이션 또는 네트워크를 이용하여 서비스를 제공하며, 이용자는 애플리케이션을 다운로드하여 설치하거나 네트워크를 이용하여 무료로 서비스를 이용할 수 있습니다. 단, 회사는 특정 서비스는 유료로 제공할 수 있으며, 이 경우 이용자는 회사가 정하는 가격으로 해당 유료서비스를 구매한 후 디바이스를 위한 전용 애플리케이션을 다운로드하여 설치하거나 네트워크를 이용하여 서비스를 이용할 수 있습니다.	\n
회사가 서비스 내에서 유료로 제공하는 인앱 유료콘텐츠는 서비스를 이용하는 과정에서 회사가 정하는 가격으로 해당 인앱 유료콘텐츠를 구매한 후 이용할 수 있습니다.	\n
...
회사는 시장 환경의 변화, 기술적 필요, 개별 서비스 이용자의 선호 감소 기타 서비스의 기획이나 운영상 또는 회사의 긴박한 상황 등에 의해 서비스 전부를 중단할 필요가 있는 경우30일 전에 각 서비스 초기화면 또는 콘텐츠 내 공지사항에 이를 공지하고 서비스의 제공을 중단할 수 있습니다. 이용자는 서비스 종료 시 사용기간이 남아 있지 않은 유료정액제 또는 기간제 유료아이템에 대하여 배상을 청구할 수 없습니다. 보증기간이 ‘영구’로 표시된 유료아이템이나 보증기간이 표시되지 않은 유료아이템의 경우, 서비스 중단 공지 시 공지된 서비스 종료일까지를 아이템의 이용 기간으로 봅니다.	\n
회사는 다음 각호에 해당하는 경우 서비스의 전부 또는 일부를 제한하거나 중지할 수 있습니다.전시, 사변, 천재지변 또는 국가비상사태 등 불가항력적인 사유가 있는 경우 2. 정전, 제반 설비의 장애 또는 이용량의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 경우 3. 서비스용 설비의 보수 등 공사로 인한 부득이한 경우 4. 회사의 제반 사정으로 서비스를 할 수 없는 경우	\n
회사는 서비스의 변경 및 중지로 발생하는 문제에 대해서는 책임을 지지 않습니다.	\n
	\n
제 14조 서비스 이용 제한	\n
	\n
이용자는 다음 각 호에 해당하는 행위를 하여서는 안되며, 해당 행위를 하는 경우에 회사는 이용자의 서비스 이용제한, 관련 정보(글, 사진, 영상 등) 삭제 및 기타의 조치를 포함한 이용제한 조치를 가할 수 있습니다.각종 신청, 변경, 등록 시 허위의 내용을 등록하거나, 타인을 기망하는 행위 2. 타인의 정보를 도용한 행위 3. 회사로부터 특별한 권리를 받지 않고 회사의 프로그램을 변경하거나, 회사의 서버를 해킹하거나 웹사이트 또는 게시된 정보의 일부분 또는 전체를 임의로 변경하거나, 회사의 서비스를 비정상적인 방법으로 사용하는 행위 4. 회사 프로그램상의 버그를 악용하거나 서비스와 관련된 설비의 오작동이나 정보 등의 파괴 및 혼란을 유발시키는 컴퓨터바이러스 감염자료를 등록 또는 유포하는 행위 5. 관련 법령에 의하여 그 전송 또는 게시가 금지되는 정보(컴퓨터프로그램) 또는 컴퓨터소프트웨어, 하드웨어, 전기통신 장비의 정상적인 가동을 방해, 파괴할 목적으로 고안된 소프트웨어 바이러스, 기타 다른 컴퓨터 코드, 파일, 프로그램을 포함하고 있는 자료를 전송, 게시, 유포, 사용하는 행위 6. 회사 서비스 운영을 고의로 방해하거나 서비스의 안정적 운영을 방해할 수 있는 정보 및 수신자의 명시적인 수신거부 의사에 반하여 광고성 정보를 전송하는 행위 7. 정상적이지 아니한 방법으로 사이버 자산(ID, 쿠폰, 포인트, 배지 ,리워드 등)을 취득, 양도 또는 매매하는 행위 8. 서비스에 위해를 가하거나 서비스를 고의로 방해하는 행위 9. 회사의 사전 승낙 없이 서비스를 이용하여 영업활동을 하는 행위 10. 본 서비스를 통해 얻은 정보를 회사의 사전 승낙 없이 서비스 이용 외의 목적으로 복제하거나, 이를 출판 및 방송 등에 사용하거나, 제3자에게 제공하는 행위 11. 타인의 특허, 상표, 영업비밀, 저작권, 기타 지적재산권을 침해하는 내용을. 전송, 게시 또는 기타의 방법으로 타인에게 유포하는 행위 12. 청소년보호법 또는 법에 위반되는 저속, 음란한 내용의 정보, 문장, 도형, 음향, 동영상을 전송, 게시 또는 기타의 방법으로 타인에게 유포하는 행위 13. 심히 모욕적이거나 개인신상에 대한 내용이어서 타인의 명예나 프라이버시를 침해할 수 있는 내용을 전송, 게시 또는 기타의 방법으로 타인에게 유포하는 행위 14. 다른 이용자를 희롱 또는 위협하거나, 특정 이용자에게 지속적으로 고통 또는 불편을 주는 행위 15. 음란, 저속한 정보를 교류, 게재하거나 음란사이트를 연결(링크)하거나 승인되지 않은 광고 및 홍보물을 게재하는 행위 16. 회사의 승인을 받지 않고 다른 사용자의 개인정보를 수집 또는 저장하는 행위 17. 회사의 직원이나 운영자를 가장하거나 사칭, 또는 타인의 명의를 도용하여 글을 게시하거나 메일을 발송하는 행위 18. 범죄와 결부된다고 객관적으로 판단되는 행위 19. 기타 관계 법령에 위배되는 행위	\n
이용자의 본 조1항에서 금지한 행위로 인해 회사에 손해가 발생한우 이용자는 일체의 손해배상 의무를 부담합니다.	\n
	\n
제5장 유료 서비스 이용	\n
	\n
...
이용자가 디바이스 및 앱스토어의 비밀번호 설정 기능 등을 이용하지 않거나 부주의하게 노출하여 발생하는 제3자의 결제에 대하여는 회사가 어떠한 책임도 부담하지 않습니다.	\n
	\n
제 17조 청약 철회 및 구매 대금의 환불 등	\n
	\n
이용자가 구매한 유료콘텐츠의 경우에는 계약 체결일 또는 유료콘텐츠 이용가능일로부터7일 이내에 별도의 수수료 없이 청약철회(구매취소)를 할 수 있습니다.	\n
이용자는 다음 각 호의 어느 하나에 해당하는 경우에는 회사의 의사에 반하여 청약철회를 할 수 없습니다. 단, 청약철회가 불가능한 유료콘텐츠의 경우 회사는 그 사실을 유료콘텐츠의 포장이나 그 밖에 이용자가 쉽게 알 수 있는 곳에 명확하게 적거나 시험 사용 상품을 제공하는 등의 방법으로 청약철회의 권리 행사가 방해받지 않도록 조치합니다. 이용자에게 책임이 있는 사유로 유료콘텐츠가 멸실되거나 훼손된 경우 2. 이용자의 사용 또는 일부 소비로 유료콘텐츠의 가치가 현저히 감소한 경우 3. 시간이 지나 다시 판매하기 곤란할 정도로 유료콘텐츠의 가치가 현저히 감소한 경우 4. 그 밖에 거래의 안전을 위하여 기타 법령으로 정하는 경우	\n
...
선물하기 기능을 통하여 이루어진 유료콘텐츠 결제에 대하여는 구매한 유료콘텐츠에 하자가 있는 경우를 제외하고는 원칙적으로 결제 취소 및 환급이 불가하며, 유료콘텐츠의 하자로 인한 환급은 선물을 보낸 이용자에 한하여 가능합니다. ⑨ 회사는 이용자로부터 환불에 필요한 관련 서류를 받은 날로부터 최대한 조속한 시일 내에 환불을 완료하도록 노력합니다.	\n
	\n
제 18조 청약철회 등의 효과	\n
	\n
이용자가 청약철회를 한 경우 이미 공급받은 유료콘텐츠를 반환하여야 하며, 회사는 이용자로부터 유료콘텐츠를 반환 받은 날부터 3영업일 이내에 이미 지급받은 유료콘텐츠의 대금을 환급합니다 단, 수납확인이 필요한 결제수단의 경우에는 수납확인일로부터 3영업일 이내에 이를 환급하도록 합니다. 이 경우 회사가 환급을 지연한 때에는 그 지연기간에 대하여 관련 법령에서 정한 이율을 곱하여 산정한 지연이자를 지급합니다.	\n
	\n
제 19조 과오금의 환불	\n
	\n
...
애플리케이션 다운로드 또는 네트워크 서비스를 이용하여 발생되는 요금(통화료, 데이터 통화료 등)은 환불 대상에서 제외될 수 있습니다.	\n
	\n
제 20조 계약 해지 및 서비스 이용 중지 등	\n
	\n
이용자는 언제든지 서비스 이용을 원하지 않는 경우 회원탈퇴를 통해 계약을 해지할 수 있습니다. 탈퇴는 즉시 처리되며 탈퇴 시 이용자가 보유한 콘텐츠 정보는 모두 삭제되어 복구가 불가능합니다.	\n
이용자가 다음 각 호 또는 제8조, 제15조1항, 각 서비스에서 별도로 정한 운영 정책 위반에 해당하는 행위를 한 경우, 이용계약을 해지하거나 또는 기간을 정하여 서비스 이용을 중지 할 수 있습니다. 서비스 신청 시에 허위 내용을 등록한 경우 2. 서비스 운영을 고의로 방해한 경우 3. 타인의 서비스 아이디 및 비밀번호를 도용한 경우 4. 서비스의 안정적 운영을 방해할 목적으로 다량의 정보를 전송하거나 광고성 정보를 전송하는 경우 5. 회사 및 이용자에게 피해를 유발시키는 컴퓨터 바이러스 프로그램 등을 유포하는 경우 6. 그 외 서비스정책에 위배되는 사항	\n
...
③    서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 법령에 정한 절차에 따른 법원을 관할 법원으로 합니다.	\n
	\n
<부칙> 본 약관은 2021년 11월 10일부터 시행됩니다. 본 약관은 2021년 11월 10일부터 시행됩니다.	\n
	\n
일  자 :  2021년 11월   일	\n
	\n
동의자 :              (서명)	\n
